    ...
    <div class="d-flex gap-2">
        <a class="btn btn-sm btn-light" href="#" title="View">
            <i class="fas fa-eye">View</i>
        </a>
        <a class="btn btn-sm btn-light" href="#" title="Edit">
            <i class="fas fa-edit">Edit</i>
        </a>
        <a class="btn btn-sm btn-light view-tasks" href="#" 
           data-bs-toggle="modal" data-bs-target="#taskModal"
           data-project-id="${project.id}" data-project-name="${project.name}" title="Tasks">
            <i class="fas fa-tasks">Task</i>
        </a>
    </div>
</td>
                        </tr>
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        <tr>
                            ...
                            <td>${clickupLink}</td>
                            <td>
                                <button class="btn btn-sm btn-light"><i class="fas fa-edit"> Edit</i></button>
                            </td>
                        </tr>
                    `;
