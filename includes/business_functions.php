	...
	if ($qry === false) {
		...
		if(!empty($user_detail['signature'])) {	// if signature exists
			...
			if($user_detail['company_id'] == 5) { 
				...
				<!-- Company 5 -->
				<table   width="100%" border="0" cellspacing="0" cellpadding="0" class="main01" style=" font-family: Arial, sans-serif; font-size: 14px ;border-collapse: collapse; margin: 0; border:none; padding:0;">
				<tbody>
					<tr>
					<td height="5" style="font-size:1px; line-height:1px;border:none;"><style>
					...
					<tr>
					<td valign="top" style="border:none;"><table width="400" border="0" cellspacing="0" cellpadding="0" align="left" style="max-width:400px;border-collapse: collapse; margin: 0; border:none; padding:0;">
						<tbody>
							<tr>
							<td valign="top" align="left" style="border:none;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin: 0; border:none; padding:0;">
								<tbody>
									<tr>
									<td valign="bottom" width="110" align="center" style="line-height:1px; margin:0px 0px 0px 0px;border:none;"><p style="line-height:1px; margin:0px 0px 12px 0px; padding:0px;"><img src="<?php echo $user_detail['user_avatar_url']; ?>" alt="head" width="110" height="110" style="width:110px; height:110px; border:none;"></p>
									<p style="line-height:1px; margin:0px 0px 0px 0px; padding:0px;"><a href="tel:<?php echo $user_detail['user_phone']; ?>"><img src="https://www.uscreditsolutions.com/signatures/btn1.png" alt="head" width="110" height="22" style="width:110px; height:22px; border:none;"></a></p>
									</td>
									<td width="15" style="font-size:1px; line-height:1px;border:none;" valign="top">&nbsp;</td>
									<td valign="middle" align="left" style="border:none;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tbody>
											<tr>
											<td colspan="2" valign="top" align="left" style="font-family:'Open Sans', Arial, Gotham, Helvetica, sans-serif; font-size:13pt; line-height:110%; color:#2c2c2c; text-align:left; border:none; ">
											<p style="line-height:1px; margin:0px 0px 0px 0px; padding:0px;"><img src="https://www.uscreditsolutions.com/signatures/ab-signature.png" alt="sign" width="130" height="36" style="width:130px; height:36px; border:none;"></p>
												<strong><?php echo $user_detail['first_name'] . " " . $user_detail['last_name']; ?></strong></td>
											</tr>
											<tr>
											<td colspan="2" height="10" style="font-size:1px; line-height:1px;border:none;"></td>
											</tr>
											<tr>
											<td colspan="2" valign="top" align="left" style="font-family:'Open Sans', Arial, Gotham, Helvetica, sans-serif; font-size:10pt; line-height:130%; color:#2c2c2c; text-align:left; border:none; "><?php echo $user_detail['designation']; ?></td>
											</tr>
											<tr>
											<td colspan="2" height="8" style="font-size:0pt; line-height:1px;border:none;"></td>
											</tr>
											<tr>
											<td valign="bottom" style="padding-left:10px; border-left:2px solid #d30124"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:left;border-collapse: collapse; margin: 0;">
												<tbody>
													<tr>
													<td width="20" style="line-height:1px;border:none;"><img src="https://www.uscreditsolutions.com/signatures/call.png" alt="icon" width="12" height="12" style="border:none; width:12px; height:12px;"></td>
													<td valign="top" align="left" style="font-family:'Open Sans', Arial, Gotham, Helvetica, sans-serif; font-size:10pt; line-height:100%; color:#000000; text-align:left; font-weight:normal;border:none;"><a href="tel:<?php echo $user_detail['user_phone']; ?>" style="color:#000000; text-decoration:none !important; text-decoration-color: #FFFFFF; font-size:10pt;"><span style="color:rgb(0,0,0);"><?php echo $user_detail['user_phone']; ?></span></a></td>
													</tr>
													<tr>
													<td colspan="2" height="5" style="font-size:0pt; line-height:1px;border:none;"></td>
													</tr>
			
													<tr>
													<td width="20" style="line-height:1px;border:none;"><img src="https://www.uscreditsolutions.com/signatures/email.png" alt="icon" width="12" height="12" style="border:none; width:12px; height:12px;"></td>
													<td valign="top" align="left" style="font-family:'Open Sans', Arial, Gotham, Helvetica, sans-serif; font-size:10pt; line-height:100%; color:#000000; text-align:left; font-weight:normal;border:none;"><a href="mailto:<?php echo $user_detail['user_email']; ?>" style="color:#000000; text-decoration:none !important; text-decoration-color: #FFFFFF; font-size:10pt;"><span style="color:rgb(0,0,0);"><?php echo $user_detail['user_email']; ?></span></a></td>
													</tr>
													<tr>
													<td colspan="2" height="5" style="font-size:0pt; line-height:1px;border:none;"></td>
													</tr>
													<tr>
													<td width="20" style="line-height:1px;border:none;"><img src="https://www.uscreditsolutions.com/signatures/web.png" alt="icon" width="12" height="12" style="border:none; width:12px; height:12px;"></td>
													<td valign="top" align="left" style="font-family:'Open Sans', Arial, Gotham, Helvetica, sans-serif; font-size:10pt; line-height:100%; color:#000000; text-align:left; font-weight:normal;border:none;"><a href="http://www.uscreditsolutions.com/" target="_blank" style="color:#000000; text-decoration:none !important; text-decoration-color: #FFFFFF; font-size:10pt;"><span style="color:rgb(0,0,0);">www.uscreditsolutions.com</span></a></td>
													</tr>
												</tbody>
												</table></td>
							...
							<tr>
							<td style="border: 1px solid #dddddd;"><p style="line-height:0px; margin:0px 0px 0px 0px; padding:0px;"><a href="https://uscreditsolutions.com/" target="_blank"><img src="https://www.uscreditsolutions.com/signatures/banner.png" alt="banner" width="400" height="70" style="width:400px; height:70px; border:none;"></a></p></td>
							</tr>
						</tbody>
						</table></td>
					</tr>
            ...
            ?>
				...
				<a href="https://www.americasfirstfinancial.com/" target="new"><img src="<?php echo $user_detail['user_avatar_url']; ?>" width="80" height="111" style="width:80px;height:111px"></a>
				</p>
				</td>
				<td style="padding-left:10px">
				<p style="font-size:14px;line-height:20px;color:#000000;margin:0px 0px 0px 0px">
				<b style="font-size:18px;color:#bf202f"><?php echo $user_detail['first_name'] . " " . $user_detail['last_name']; ?></b><br><b><?php echo $user_detail['designation']; ?></b>
				</p>
				<p style="font-size:14px;line-height:23px;color:#000000;margin:5px 0px 0px 0px">
				<img src="https://www.americasfirstfinancial.com/signatures/Phone-call.png" width="12" height="12" style="width:12px;height:12px"> <a href="tel:<?php echo $user_detail['user_phone']; ?>" target="new" style="text-decoration:none;color:#000000"><?php echo $user_detail['user_phone']; ?></a><br>
				<img src="https://www.americasfirstfinancial.com/signatures/Envelope.png" width="12" height="12" style="width:12px;height:12px"> <a href="mailto:<?php echo $user_detail['user_email']; ?>" target="new" style="text-decoration:none;color:#000000"><?php echo $user_detail['user_email']; ?></a><br>
				<img src="https://www.americasfirstfinancial.com/signatures/Web.png" width="12" height="12" style="width:12px;height:12px"> <a href="https://www.americasfirstfinancial.com/" target="new" style="text-decoration:none;color:#000000">www.americasfirstfinancial.com </a>
				</p>
				</td>
					<td style="padding-left:5px">
						<p style="font-size:14px;line-height:20px;color:#000000;margin:0px 0px 0px 0px">
							<a href="https://www.americasfirstfinancial.com/" target="new"><img src="https://americasfirstfinancial.com/signatures/americas-first-finanical-logo.png" width="130" height="82" style="width:130px;height:82px"></a>
						</p>
						</td>
				</tr>
				<tr><td colspan="2">
            ...
            ?>
				...
				<!-- Company 2 -->
					<table style="font-family: Arial, sans-serif; font-size: 14px;" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
					<tr>
						...
						<a href="https://liberty1financial.com/" style="text-decoration: none;">
							<img src="<?php echo $user_detail['user_avatar_url']; ?>" width="80" height="111" alt="Liberty1 Financial" style="display: block;" />
						</a>
						</td>
						<td colspan="3" width="280" style="padding-left: 10px;border:none;">
						<p style="font-size: 18px; color: #389647; margin: 0 0 5px 0; font-weight: bold;"><?php echo $user_detail['first_name'] . " " . $user_detail['last_name']; ?></p>
						<p style="font-size: 14px; color: #000000; margin: 0 0 5px 0; font-weight: bold;"><?php echo $user_detail['designation']; ?></p>
						<p style="font-size: 14px; color: #000000; margin: 0;">
							<img src="https://liberty1financial.com/signatures/Phone-call.png" width="12" height="12" alt="Phone Icon" style="display: inline-block; vertical-align: middle;" />
							<a href="tel:<?php echo $user_detail['user_phone']; ?>" target="_blank" style="text-decoration: none; color: #000000;"><?php echo $user_detail['user_phone']; ?></a>
							<br />
							<img src="https://liberty1financial.com/signatures/Envelope.png" width="12" height="12" alt="Email Icon" style="display: inline-block; vertical-align: middle;" />
							<a href="mailto:<?php echo $user_detail['user_email']; ?>" target="_blank" style="text-decoration: none; color: #000000;"><?php echo $user_detail['user_email']; ?></a>
							<br
							<img src="https://liberty1financial.com/signatures/Web.png" width="12" height="12" alt="Web Icon" style="display: inline-block; vertical-align: middle;" />
							<a href="https://www.liberty1financial.com/" target="_blank" style="text-decoration: none; color: #000000;">www.liberty1financial.com</a>
						</p>
						</td>
						...
						<p style="font-size: 14px; line-height: 20px; color: #000000; margin: 0 0 15px 0;border:none;">
							...
							<img src="https://liberty1financial.com/signatures/Liberty1Financial-logo.png" width="130" height="82" alt="Liberty1 Financial Logo" style="width: 130px; height: 82px; display: block;">
							</a>
						</p>
						</td>
					</tr>
					<tr>
						<td colspan="5" style="border:none;">
                            ...
                            <!-- </a> -->
                            <img src="https://liberty1financial.com/signatures/veteran-owned-biz.png" width="94" height="93" alt="Veteran Owned" >
                            <a style="text-decoration: none;" href="https://www.inc.com/liberty1financial/lenders-on-a-mission-when-your-success-secret-is-empowering-consumers.html" target="_blank"><img src="https://liberty1financial.com/mail/liberty-7/inc-r-1.png"  height="93" alt="" ></a>
                            <a style="text-decoration: none;" href="https://www.inc.com/inc5000/2024" target="_blank"><img src="https://liberty1financial.com/mail/liberty-7/inc-r-2.png" height="93" alt="" ></a>
                        </td>
				    </tr>
				</table>
